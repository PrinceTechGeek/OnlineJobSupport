...
type FilterPanelProps = {
  filters: Record<'skills' | 'locations' | 'salaryRanges' | 'jobTypes', string[]>;
  selectedFilters: Record<'skills' | 'locations' | 'salaryRanges' | 'jobTypes', string[]>;
  onFilterChange: (filterKey: 'skills' | 'locations'
  | 'salaryRanges' | 'jobTypes', value: string) => void;
  globalSearch: string;
  onGlobalSearchChange: (value: string) => void;
  searchTerms: Record<'skills' | 'locations' | 'salaryRanges' | 'jobTypes', string>;
  onSearchTermChange: (filterKey: 'skills' | 'locations'
  | 'salaryRanges' | 'jobTypes', value: string) => void;
  onRemoveFilter: (filterKey: 'skills' | 'locations'
  | 'salaryRanges' | 'jobTypes', value: string) => void;
  getFilteredOptions: (
    filterKey: 'skills' | 'locations' | 'salaryRanges' | 'jobTypes',
    options: string[],
  ) => string[];
};
